...
export const ARTBOARD_SIZE_PRESETS: ArtboardSizePreset[] = [
  ...
  // Tablet
  { id: "ipad-pro-13", label: "iPad Pro 13″ (M4)", width: 1024, height: 1366, category: "Tablet" },
  { id: "ipad-pro-11", label: "iPad Pro 11″ (M4)", width: 834, height: 1194, category: "Tablet" },
  { id: "ipad-air-13", label: "iPad Air 13″ (M3)", width: 1024, height: 1366, category: "Tablet" },
  { id: "ipad-air-11", label: "iPad Air 11″ (M3)", width: 820, height: 1180, category: "Tablet" },
  { id: "ipad-mini", label: "iPad mini (A17 Pro)", width: 744, height: 1133, category: "Tablet" },
  { id: "galaxy-tab-s10", label: "Galaxy Tab S10 Ultra", width: 960, height: 1500, category: "Tablet" },
  ...
  { id: "iphone-air", label: "iPhone Air", width: 402, height: 874, category: "Mobile" },
  { id: "iphone-se", label: "iPhone SE", width: 375, height: 667, category: "Mobile" },
  { id: "pixel-9-pro-xl", label: "Pixel 9 Pro XL", width: 432, height: 960, category: "Mobile" },
  { id: "pixel-9-pro", label: "Pixel 9 Pro", width: 412, height: 915, category: "Mobile" },
  { id: "galaxy-s25-ultra", label: "Galaxy S25 Ultra", width: 384, height: 832, category: "Mobile" },
  { id: "galaxy-s25", label: "Galaxy S25", width: 360, height: 780, category: "Mobile" },
  { id: "galaxy-z-fold", label: "Galaxy Z Fold (unfolded)", width: 884, height: 1104, category: "Mobile" },
]
